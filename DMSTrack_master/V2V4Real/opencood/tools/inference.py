...
def test_parser(
    ...
    parser.add_argument('--model_dir', default=DATA_DIR, type=str, required=False,
    ...
    parser.add_argument('--save_npy',default=True, action='store_true',
...
def main(
      data_dir = '',
      config_path='/home/maji/Downloads/V2XTargetTracking-main/V2XGen-main/target_tracking/rq1/results/late_fusion',
      fusion_method = 'no_fusion_keep_all',

):  


    opt = test_parser(DATA_DIR=data_dir,FUSION_METHOD=fusion_method)
