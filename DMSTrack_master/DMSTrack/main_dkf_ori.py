...
# import os
os.chdir('/app/V2X-ATCT/DMSTrack_master/DMSTrack') 
...
def get_config(cfg, cat, training_split, evaluation_split, seq_eval_mode, use_reversed_cav_id_list):
  ...
  if 'multi_sensor_differentiable_kalman_filter' in cfg.det_name:
    ...
    # val_detection_feature_path = '/home/maji/Downloads/V2XTargetTracking-main/DMSTrack_master/V2V4Real/data/test/ori_data/npy'
  else: # cobevt + dkf
