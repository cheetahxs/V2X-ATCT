...
def caluclate_tp_fp(det_boxes, det_score, gt_boxes, result_stat, iou_thresh,
    ...
    if det_boxes is not None:
        ...
        # averageIOU = 0
        sumIOU = result_stat[iou_thresh]['sumIOU']
        numIOUs = result_stat[iou_thresh]['numIOUs']
        ...
        # if numIOUs !=0:
        #     averageIOU  = sumIOU / numIOUs
        # else :
        #     averageIOU = 0
        # print(f'averIOU:{averageIOU}')
    ...
    # print(f'numIOUs:{numIOUs}')

    result_stat[iou_thresh]['sumIOU'] = sumIOU
    result_stat[iou_thresh]['numIOUs'] = numIOUs



def calculate_ave_iou(result_stat, iou):
...
def eval_final_results(result_stat, save_path, range=""):
    ...
    ave_iou_50 = calculate_ave_iou(result_stat,0.5)
    ave_iou_70 = calculate_ave_iou(result_stat,0.7)
    ...
    dump_dict.update({'ap_50': ap_50,
                      ...
                      'mpre_70': mpre_70,
                      'mrec_70': mrec_70,
                      'ave_iou_50':ave_iou_50,
                      'ave_iou_70':ave_iou_70
                      })
    ...
    print('The range is %s, '
          ...
          'The Average Precision at IOU 0.7 is %.3f,' 
            'The Average IOU 0.5 is %.3f,' 
            'The Average IOU 0.7 is %.3f' % (range,  ap_50, ap_70,ave_iou_50,ave_iou_70),)
